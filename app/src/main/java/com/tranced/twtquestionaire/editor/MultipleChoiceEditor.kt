...
import com.tranced.twtquestionaire.data.Option
...
class MultipleChoiceEditor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.multiple_choice_editor)
//        setActivitySize()
        findViews()
        setToolbar()
    ...
    private fun findViews() {
        ...
        stemEditText = findViewById(R.id.q1_e_multiple_input_question)
        addOptionButton = findViewById(R.id.q1_e_multiple_add_option)
        compulsionSwitch = findViewById(R.id.q1_e_multiple_compulsion_switch)
        answerButton = findViewById(R.id.q1_e_multiple_answer_button)
        scoreButton = findViewById(R.id.q1_e_multiple_score_button)
        conditionButton = findViewById(R.id.q1_e_multiple_condition_button)
        jumpButton = findViewById(R.id.q1_e_multiple_jump_button)
...
//            }
    ...
    private fun initOptionListRecyclerView() {
        ...
        optionListRecyclerView.apply {
            layoutManager = LinearLayoutManager(this@MultipleChoiceEditor)
            adapter = MultipleOptionAdapter()
            (adapter as MultipleOptionAdapter).apply {
                (adapter as MultipleOptionAdapter).setOnDeleteListener(object :
                    MultipleOptionAdapter.OnDeleteListener {
                    override fun onDelete(position: Int) {
                        (adapter as MultipleOptionAdapter).apply {
                            if (optionList.size <= 1) {
                                Toasty.error(
                                    this@MultipleChoiceEditor,
                                    "别删啦，再删人就傻啦！",
                                    Toasty.LENGTH_SHORT
                                ).show()
                            } else {
        ...
        addOptionButton.onClick {
            (optionListRecyclerView.adapter as MultipleOptionAdapter).apply {
                optionList.add(
                    Option(
                        "",
                        optionList.size,
    ...
    private fun setOnClickListeners() {
        answerButton.onClick {
            ...
            if (!isAnyOptionEmpty) {
                val dialog = QMUIDialog.MultiCheckableDialogBuilder(this@MultipleChoiceEditor)
        ...
        scoreButton.onClick {
            val builder = QMUIDialog.EditTextDialogBuilder(this@MultipleChoiceEditor)
            builder.setTitle("请输入分值")
                ...
                .addAction("确定") { dialog, _ ->
                    if (builder.editText.text.toString().isNotEmpty()) {
                        ...
                        Toasty.error(this@MultipleChoiceEditor, "请输入分值").show()
                        scoreButton.setText(R.string.q1_e_unsettled)
                    }
                }
                .show()
    ...
    private class MultipleOptionAdapter :
        ...
        override fun onCreateViewHolder(
            ...
            val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.single_choice_editor_option, parent, false)
            ...
            return MultipleOptionViewHolder(itemView, editText, deleteButton)
        }
        ...
        override fun onBindViewHolder(holder: MultipleOptionViewHolder, position: Int) {
    ...
    private class MultipleOptionViewHolder(
        itemView: View,
